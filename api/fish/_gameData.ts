...
export const NO_BITE_MESSAGES = [
  "Not even a nibble...",
  "The water is calm. Too calm.",
  "Something stole the bait!",
  "A boot almost bit, but then it got away.",
  "Just ripples and dreams.",
  "Maybe try a different spot?",
  "The fish are laughing at you.",
  "Quiet day in the deep.",
  "You feel a pull, but it's just the current.",
  "Is that a mermaid? No, just a rock."
];
